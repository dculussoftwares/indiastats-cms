...
if (!X_OAUTH2_REFRESH_TOKEN)  missing.push('X_OAUTH2_REFRESH_TOKEN  ← run: node scripts/oauth2-setup.mjs');
...
try {
  ...
  const { client, accessToken: _accessToken, refreshToken } = await appClient.refreshOAuth2Token(X_OAUTH2_REFRESH_TOKEN);
  tweetClient = client;
...
const DISTRICT_MAP = {
  ...
  dt7:  ['ac041','ac042','ac043','ac044','ac045','ac046','ac047','ac048',
          'ac049','ac050','ac051','ac052','ac053','ac054','ac055','ac056',
          'ac057','ac058','ac059','ac060','ac061','ac062','ac063','ac064',
          'ac065','ac066','ac067','ac068','ac069','ac070','ac071','ac072',
          'ac073','ac074','ac075','ac076','ac077','ac078','ac079','ac080',
          'ac081','ac082','ac083','ac084','ac085','ac086','ac087','ac088',
          'ac089','ac090','ac091','ac092','ac093','ac094','ac095','ac096',
          'ac097','ac098'],
...
const pageUrl = `${SITE_URL}/tamil-nadu/assembly/${districtId}/${assemblyId}`;
