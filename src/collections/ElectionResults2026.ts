...
export const ElectionResults2026: CollectionConfig = {
    ...
    admin: {
        ...
        defaultColumns: ['assemblyId', 'assemblyName', 'districtName', 'status', 'currentRound', 'totalRounds'],
        group: 'Election Data',
        description: 'Live 2026 TN election counting data — one record per assembly. assemblyId is the unique key (e.g. ac001).',
    },
    access: {
        read: () => true,
    },
